package com.androidalians.androidpoint.Activity.Characters.Ludo.Player;
...
import com.androidalians.androidpoint.Activity.Characters.Arrows;
...
import com.androidalians.androidpoint.Activity.LudoGame;
    ...
    public Player(int si, int ei, Position[] piecePos, int pieceSize, Position[] path, String col) {
        ...
        for (int i = 0; i < 51; i++) {
            ...
            if (si + i > 51) {
                ...
                romPath[i] = LudoGame.romPath[si + i - 52];
            } else {
                romPath[i] = LudoGame.romPath[si + i];
            }
        }
