...
public class NomRunGame extends AppCompatActivity {
    ...
    private void showRewardedAdIfNeeded() {
        if (adCount < 2) {
            if (isRewardedAdLoaded) {
                rewardedAd.show(NomRunGame.this, new OnUserEarnedRewardListener() {
                    @Override
    ...
    private void loadRewardedAd() {
        ...
        RewardedAd.load(this, "ca-app-pub-3471867131564882/6114627103", adRequest, new RewardedAdLoadCallback() {
            @Override
